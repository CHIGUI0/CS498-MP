...
class lanenet_detector():
    ...
    def color_thresh(self, img, thresh=(100, 255)):
        ...
        r1_mask = cv2.inRange(image_hls, r1_lower, r1_upper)
        r2_mask = cv2.inRange(image_hls, r2_lower, r2_upper)
        # Step 5: Combine masks (optional)
        combined_mask = cv2.bitwise_or(r1_mask,r2_mask)
    ...
    def perspective_transform(self, img, verbose=False):
        ...
        shape_y = img.shape[0]
        # for project 
        src_points = np.float32([[0.1*shape_x,3/5*shape_y],[0.9*shape_x,3/5*shape_y],[shape_x,shape_y],[0,shape_y]])
        dst_points = np.float32([[0,0],[shape_x,0],[shape_x,shape_y],[0,shape_y]])
        # Uncomment this block for lane detection of Bags 0011&0056
        # For Bag-0011&0056
        ...
        if not self.hist:
            ...
            if not self.detected:
                ...
                if ret is not None:
                    ...
                    mid_fit = self.left_line.add_fit(mid_fit)
                ...
                ret = tune_fit(img_birdeye, left_fit)
